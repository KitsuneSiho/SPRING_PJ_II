        ...
        <div class="panel-body">
            <form action="${root }/memberImageUpdate" method="post" enctype="multipart/form-data">
                ...
                <table class='table table-bordered' style="text-align: center;">
                    ...
                    <tr>
                        <td style="width: 100px; vertical-align: middle;" />사진업로드
                        </td>
                        <td colspan="2">
                            <span class="btn btn-default">사진업로드<input type="file" name="memberProfile"/>
                            </span>
                    </tr>

                    <tr>
                        <td colspan="2"><input type="submit"
                                               class="btn btn-primary btn-sm pull-right" value="사진등록"></td>
                    </tr>
                </table>
            </form>
        </div>
